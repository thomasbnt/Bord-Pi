...
module.exports = (bot, WebhookPublic, msg, args) => {
  ...
  const Motd = ['ThisIsFlume', 'Henry III', '👋', '🍣', '😎', 'E Corpé', 'Mee1 premier du nom', 'Raspi, se sentir utile !', '💡 Je suis né(e) sur un Raspberry Pi !', 'Dernière génération en route...', 'Lorem Ipsum', 'Loogé et coffré.', 'Est-tu un 0 ou un 1?', "Le violet c'est beau", '🌧 > 🌞']
