...
exports.run = (bot, WebhookPrivate, WebhookPublic, msg) => {
    ...
    msg.channel.send(
        BordEmbed
            ...
            .addField("Autres commandes", bot.config.prefix + "sd, " + bot.config.prefix + "avatar, " + bot.config.prefix + "form, " + bot.config.prefix + "markdown, " + bot.config.prefix + "uptime, " + bot.config.prefix + "ping ")
            .addField("Formulaire de recrutement et des demandes de partenariat", "Vous voulez nous rejoindre en tant que membre de l'équipe **La Hype_** ? Ou bien devenir partenaire ? [Remplissez ce formulaire](https://thomasbnt.fr/form).", false)
            .addField("Les liens utiles", "[Serveur Discord](https://discord.gg/9gcxwVY) • [Me soutenir](https://www.patreon.com/thomasbnt) • [Site web](https://thomasbnt.fr/?utm_source=link_embed_footer_bordpi?utm_medium=discordapp) • [Code Source de Bord Pi](https://github.com/thomasbnt/Bord-Pi)", false)
    )
