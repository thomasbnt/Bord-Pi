...
exports.run = (bot, WebhookPublic, msg) => {
    ...
    msg.channel.send(new Discord.MessageEmbed()
            ...
            .addField("Les rôles que vous pouvez avoir", "**" + bot.config.prefix + "gratuit**— Soyez notifié quand un jeu gratuit sort !\n " + "**" + bot.config.prefix + "joueur**— Rôle permettant d'être notifié pour les parties privées sur diverses jeux.\n " + "**" + bot.config.prefix + "dev** — Rôle pour les développeurs en tout genre\n**" + bot.config.prefix + "elec** — Rôle pour les électroniciens en tout genre", false)
